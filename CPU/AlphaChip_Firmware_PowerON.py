...
def PowerON():
    ...
    if AlphaChip_Memory.g_b_Debugging:
        ...
        Tkinter_Display_Start.insert_Low_16_TP2_MAX_text.delete(0,10)
        Tkinter_Display_Start.insert_Low_64_TP2_MIN_text.delete(0,10)
        Tkinter_Display_Start.insert_Low_64_TP2_MAX_text.delete(0,10)
        Tkinter_Display_Start.insert_High_TP1_text.delete(0,10)
        ...
        Tkinter_Display_Start.insert_High_64_TP2_MAX_text.delete(0,10)

        Tkinter_Display_Start.insert_Low_Gain_text.insert(0, str(AlphaChip_Memory.g_N_CIS_SET_REGISTER['_LOW_AMP_GAIN']))
        Tkinter_Display_Start.insert_Low_Inttime_text.insert(0, str(AlphaChip_Memory.g_N_CIS_SET_REGISTER['_LOW_INTEGRATION_TIME']))
        Tkinter_Display_Start.insert_Low_Inttime_UD_text.insert(0, str(AlphaChip_Memory.g_N_CIS_SET_REGISTER['_LOW_INTEGRATION_TIME_UD_SEL']))
        Tkinter_Display_Start.insert_High_Gain_text.insert(0, str(AlphaChip_Memory.g_N_CIS_SET_REGISTER['_HIGH_AMP_GAIN']))
        Tkinter_Display_Start.insert_High_Inttime_text.insert(0, str(AlphaChip_Memory.g_N_CIS_SET_REGISTER['_HIGH_INTEGRATION_TIME']))
        Tkinter_Display_Start.insert_High_Inttime_UD_text.insert(0, str(AlphaChip_Memory.g_N_CIS_SET_REGISTER['_HIGH_INTEGRATION_TIME_UD_SEL']))
        Tkinter_Display_Start.insert_Raw_Gain_text.insert(0, str(AlphaChip_Memory.g_N_RAW_CIS_SET_REGISTER['_RAW_AMP_GAIN']))
        Tkinter_Display_Start.insert_Raw_Inttime_text.insert(0, str(AlphaChip_Memory.g_N_RAW_CIS_SET_REGISTER['_RAW_INTEGRATION_TIME']))
        Tkinter_Display_Start.insert_Low_TP1_text.insert(0, str(AlphaChip_Memory.g_TP1_REGISTER['_LOW_TP1']))
        ...
        Tkinter_Display_Start.insert_Low_16_TP2_MIN_text.insert(0, str(AlphaChip_Memory.g_TP2_16_LOW_REGISTER['_LOW_16_TP2_MIN']))
        Tkinter_Display_Start.insert_Low_16_TP2_MAX_text.insert(0, str(AlphaChip_Memory.g_TP2_16_LOW_REGISTER['_LOW_16_TP2_MAX']))
        Tkinter_Display_Start.insert_Low_64_TP2_MIN_text.insert(0, str(AlphaChip_Memory.g_TP2_64_LOW_REGISTER['_LOW_64_TP2_MIN']))
        Tkinter_Display_Start.insert_Low_64_TP2_MAX_text.insert(0, str(AlphaChip_Memory.g_TP2_64_LOW_REGISTER['_LOW_64_TP2_MAX']))
        Tkinter_Display_Start.insert_High_TP1_text.insert(0, str(AlphaChip_Memory.g_TP1_REGISTER['_HIGH_TP1']))
        ...
        Tkinter_Display_Start.insert_High_64_TP2_MIN_text.insert(0, str(AlphaChip_Memory.g_TP2_64_HIGH_REGISTER['_HIGH_64_TP2_MIN']))
        Tkinter_Display_Start.insert_High_64_TP2_MAX_text.insert(0, str(AlphaChip_Memory.g_TP2_64_HIGH_REGISTER['_HIGH_64_TP2_MAX']))
